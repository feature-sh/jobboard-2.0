...
const FeatureHeader = () => {
  ...
  return (
    <header className="relative bg-white/90 backdrop-blur-sm border-b border-gray-200 z-50">
        ...
        <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <span className="font-bold text-xl hidden sm:block">FEATURE</span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            {/* GitHub link */}
            <a
              href="https://github.com/feature-sh"
              target="_blank"
